...
namespace VideoConsole.FFmpegOP
{
    public class VideoWorker : ISample
    {
        public void Run()
        {
            //选择硬件解码驱动
            ...
            //解关键帧
            Console.WriteLine("解码中...");
            //解码源关键帧
            DecodeAllFramesToImages(deviceType,SampleConfiguration.SOURCE_VIDEO_PATH,SampleConfiguration.SOURCE_KEY_FRAME_PATH);
            //解码比对关键帧
            //DecodeAllFramesToImages(deviceType, SampleConfiguration.CUT_VIDEO_PATH, SampleConfiguration.CUT_KEY_FRAME_PATH);
        }
        public void ConfigureHWDecoder(out AVHWDeviceType HWtype)
        {
        ...
        public unsafe void SetupLogging()
        {
        ...
        public AVPixelFormat GetHWPixelFormat(AVHWDeviceType hWDevice)
        {
            switch (hWDevice)
            {
